	...
	public function get_option() {
		$this->options[] = array(
			...
			'value'       => array(
				...
				esc_html__( 'Telegram', 'jnews' )      => 'telegram', // see rYir2Qgd
				esc_html__( 'Dribbble', 'jnews' )      => 'dribbble',
				esc_html__( 'Stumbleupon', 'jnews' )   => 'stumbleupon',
				...
				esc_html__( 'Odnoklassniki', 'jnews' ) => 'odnoklassniki',
				...
				esc_html__( 'Xing', 'jnews' )          => 'xing',
				esc_html__( 'Bluesky', 'jnews' )       => 'bluesky',
			),
		);
