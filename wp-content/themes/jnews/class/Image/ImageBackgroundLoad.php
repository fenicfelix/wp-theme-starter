...
Class ImageBackgroundLoad implements ImageInterface
{
	...
	public function single_hero_image( $id, $size, $prioritize = false ) {
        ...
        $hidden_image = $prioritize ? "<img class=\"thumbnail-prioritize\" src=\"{$image}\" style=\"display: none\" >" : '';

        $thumbnail = "<div class=\"thumbnail-container thumbnail-background\" data-src=\"{$image}\" >
                        <div class=\"lazyloaded\" data-src=\"{$image}\" style=\"background-image: url($image)\">{$hidden_image}</div>
                    </div>";
