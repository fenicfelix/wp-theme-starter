					...
					if ( ! empty( $social->social_url ) ) {
						switch ( $social->social_icon ) {
							...
							case 'tiktok':
								...
								$output .= '<a href="' . $social->social_url . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $social->social_icon ) . '" class="jeg_line_tiktok">
