...
$options[] = [
	...
	'transport'       => 'postMessage',
	'default'         => wp_kses( 'This website uses cookies. By continuing to use this website you are giving consent to cookies being used. Visit our <a href="#">Privacy and Cookie Policy</a>.', wp_kses_allowed_html() ),
	'type'            => 'jnews-textarea',
	'html_editor'	  => true,
...
$options[] = [
	...
	'transport'       => 'postMessage',
	'default'         => wp_kses( 'I agree to the Terms &amp; Conditions and <a href="#">Privacy Policy</a>.', wp_kses_allowed_html()  ),
	'type'            => 'jnews-textarea',
	'html_editor'	  => true,
...
$options[] = [
	...
	'transport'       => 'postMessage',
	'default'         => wp_kses( '<span class="required">*</span>By registering into our website, you agree to the Terms &amp; Conditions and <a href="#">Privacy Policy</a>.', wp_kses_allowed_html() ),
	'type'            => 'jnews-textarea',
	'html_editor'	  => true,
	'label'           => esc_html__( 'Privacy Policy Text', 'jnews' ),
	'description'     => esc_html__( 'Insert text for privacy policy text.', 'jnews' ),
...
$options = apply_filters( 'jnews_global_gdpr_option', $options );
