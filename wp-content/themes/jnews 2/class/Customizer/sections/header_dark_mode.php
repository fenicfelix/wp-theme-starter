...
$options[] = array(
	'id'              => 'jnews_dark_mode_cookie_time', /* see cahqJM4J */
	'type'            => 'jnews-select',
	'label'           => esc_html__( 'Dark Mode Cookie Time', 'jnews' ),
	'default'         => 1,
	'choices'         => array(
		0  => esc_html__( 'Current Session', 'jnews' ),
		1  => esc_html__( 'Save for 1 Day', 'jnews' ),
		7  => esc_html__( 'Save for 7 Day', 'jnews' ),
		30 => esc_html__( 'Save for 30 Day', 'jnews' ),
	),
	'active_callback' => array(
		array(
			'setting'  => 'jnews_dark_mode_options',
			'operator' => 'in',
			'value'    => array( 'jeg_toggle_light', 'jeg_toggle_dark', 'jeg_device_toggle' ),
		),
	),
);
