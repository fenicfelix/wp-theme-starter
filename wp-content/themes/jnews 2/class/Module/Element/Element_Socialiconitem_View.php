		...
		if ( ! empty( $attr['social_url'] ) ) {
			switch ( $attr['social_icon'] ) {
				case 'facebook':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_facebook">
				...
				case 'linkedin':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_linkedin">
				...
				case 'behance':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_behance">
				...
				case 'github':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_github">
				...
				case 'flickr':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_flickr">
				...
				case 'tumblr':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_tumblr">
				...
				case 'dribbble':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_dribbble">
				...
				case 'soundcloud':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_soundcloud">
				...
				case 'instagram':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_instagram">
				...
				case 'vimeo':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_vimeo">
				...
				case 'youtube':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_youtube">
				...
				case 'vk':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . strtoupper( $attr['social_icon'] ) . '" class="jeg_vk">
				...
				case 'twitch':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_twitch">
				...
				case 'reddit':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_reddit">
				...
				case 'weibo':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_weibo">
				...
				case 'rss':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . strtoupper( $attr['social_icon'] ) . '" class="jeg_rss">
				...
				case 'tiktok':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_tiktok">
				...
				case 'threads':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_threads">
				...
				case 'twitter':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_twitter">
				...
				case 'discord':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_discord_chat">
				...
				case 'line':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_line_chat">
				...
				case 'snapchat':
					...
					$output .= '<a href="' . $attr['social_url'] . '" target="_blank" rel="external noopener nofollow" aria-label="' . esc_html__( 'Find us on ', 'jnews' ) . ucwords( $attr['social_icon'] ) . '" class="jeg_snapchat">
