...
class PopularWidget implements NormalWidgetInterface {
	...
	public function first_item( $key, $value ) {
		...
		$twitter_icon       = jnews_get_svg( 'twitter' ); // see qUf5zglP
		$output             =
			'<li ' . jnews_post_class( 'popularpost_item', $value->ID ) . '>
                <div class="jeg_thumb">
                    ' . jnews_edit_post( $value->ID ) . "
                    <a href=\"{$permalink}\" aria-label=\"" . esc_html__( 'Read article: ', 'jnews' ) . get_the_title( $value->ID ) . "\">{$thumbnail}</a>
                </div>
                ...
                <div class=\"popularpost_meta\">
                    <div class=\"jeg_socialshare\">
                        ...
                        <div class=\"socialshare_list\">
                            ...
                            <a href=\"{$twitter_share_url}\" class=\"jeg_share_tw\"><span class=\"share-text\">" . $twitter_icon . jnews_return_translation( 'Tweet', 'jnews', 'tweet' ) . "</span> <span class=\"share-count\">{$twitter_share}</span></a>
                        </div>
                    </div>
                </div>
            </li>";
