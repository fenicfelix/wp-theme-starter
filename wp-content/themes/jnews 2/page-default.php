            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="jeg_main_content col-md-<?php echo esc_attr($single->column_width()) ?>">
                        ...
                        <?php if (jnews_can_render_breadcrumb() && jnews_get_metabox_value('jnews_single_page.show_post_breadcrumbs', true)) : ?>
                        ...
                        <div class="entry-header">
                            <?php if (jnews_get_metabox_value('jnews_single_page.show_post_title', true)) : ?>
                        ...
                        <?php
                        if (jnews_get_metabox_value('jnews_single_page.show_post_featured', true)) {
